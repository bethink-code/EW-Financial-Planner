...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    this.createRetirementFund({
      ...
      monthlyIncomeCheckbox: true,
      termYears: "10",
      increasePercentage: "5%",
      approvedCover: "R 500,000",
      fundValue: "R 180,000",
      fundValueAtDeath: "R 200,000",
      fundBeneficiary: "Sarah Doe",
      coverPercentageSplit: "100%",
      additionalFundBeneficiaries: [],
      additionalCoverPercentageSplits: [],
      lumpSumTaken: "R 25,000",
      nondeductibleContribution: "R 10,000",
      livingAnnuity: "R 120,000",
      livingAnnuityCheckbox: true,
      incomeTerm: "20"
    });
    ...
    this.createRetirementFund({
      ...
      approvedCover: "R 175,000",
      fundValue: "R 120,000",
      fundValueAtDeath: "R 140,000",
      fundBeneficiary: "Tom Smith",
      coverPercentageSplit: "60%",
      additionalFundBeneficiaries: ["Anna Smith"],
      additionalCoverPercentageSplits: ["40%"],
