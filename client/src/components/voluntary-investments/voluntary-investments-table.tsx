      ...
      <div className="overflow-x-auto">
        ...
        <thead>
          <tr className="double-row-header-first">
            ...
            <th className="section-start" colSpan={2}>Bequeath To</th>
            <th className="section-start" colSpan={4}>Exclusions</th>
          </tr>
          <tr className="double-row-header-second">
            <th className="section-start">Description</th>
            <th>Owner</th>
            <th>Ownership %</th>
            <th className="section-start">Base Cost</th>
            <th>Market Value</th>
            <th>Liquidation %</th>
            <th className="section-start">Spouse</th>
            <th>Others</th>
            <th className="section-start">Joint Estate</th>
            <th>Estate Duty</th>
            <th>CGT</th>
            <th>Executor's Fees</th>
          </tr>
        </thead>
          ...
          {investments.map((investment: VoluntaryInvestment, investmentIndex) => {
            ...
            return Array.from({ length: maxRows }, (_, ownerIndex) => (
              ...
              >
                ...
                {ownerIndex === 0 && (
                  <td className="p-1 align-top section-start" rowSpan={maxRows}>
                    <input
                      type="text"
                ...
                {ownerIndex === 0 && (
                  <>
                    ...
                    <td className="p-1 text-center section-start align-top" rowSpan={maxRows}>
                      <input
                        type="checkbox"
