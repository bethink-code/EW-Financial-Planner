              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center bg-[#F5F1E8] rounded-[6px] overflow-hidden">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center h-8 w-8 rounded text-sm font-semibold bg-[#F97415] text-white ml-1 mr-1 my-1 hover:bg-[#F97415] hover:opacity-90 transition-colors"
                  >
