...
export const retirementFunds = pgTable("retirement_funds", {
  ...
  ownershipPercentages: text("ownership_percentages")
    .array()
    .notNull()
    .default(["100%"]),
  ...
  unapprovedBeneficiaries: text("unapproved_beneficiaries")
    .array()
    .notNull()
    .default([""]),
  unapprovedPercentageSplits: text("unapproved_percentage_splits")
    .array()
    .notNull()
    .default(["0%"]),
  unapprovedCoverSplits: text("unapproved_cover_splits")
    .array()
    .notNull()
    .default(["R 0"]), // Calculated

  // Monthly Death Benefit Section
  monthlyIncome: text("monthly_income").notNull().default("R 0"),
  monthlyIncomeCheckbox: boolean("monthly_income_checkbox")
    .notNull()
    .default(false),
  ...
  fundValueBeneficiaries: text("fund_value_beneficiaries")
    .array()
    .notNull()
    .default([""]),
  fundValuePercentageSplits: text("fund_value_percentage_splits")
    .array()
    .notNull()
    .default(["0%"]),
  fundValueCoverSplits: text("fund_value_cover_splits")
    .array()
    .notNull()
    .default(["R 0"]), // Calculated
  lumpSumTaken: text("lump_sum_taken").notNull().default("R 0"),
  nonDeductibleContribution: text("non_deductible_contribution")
    .notNull()
    .default("R 0"),
  livingAnnuity: text("living_annuity").notNull().default("R 0"), // Calculated
  livingAnnuityCheckbox: boolean("living_annuity_checkbox")
    .notNull()
    .default(false),
  ...
  beneficiaryPercentageSplit: text("beneficiary_percentage_split")
    .notNull()
    .default("0%"),
  additionalBeneficiaries: text("additional_beneficiaries")
    .array()
    .notNull()
    .default([]),
  additionalBenefitSplits: text("additional_benefit_splits")
    .array()
    .notNull()
    .default([]),
  ...
  fundValueAfterLumpSum: text("fund_value_after_lump_sum")
    .notNull()
    .default("R 0"),
  monthlyIncomeTerm: text("monthly_income_term").notNull().default("0 years"),
  lumpSumProvisionEstate: text("lump_sum_provision_estate")
    .notNull()
    .default("R 0"),
  lumpSumProvisionSpouse: text("lump_sum_provision_spouse")
    .notNull()
    .default("R 0"),
  lumpSumProvisionOther: text("lump_sum_provision_other")
    .notNull()
    .default("R 0"),
  currentAnnualIncome: text("current_annual_income").notNull().default("R 0"),
  monthlyProvisionOffered: text("monthly_provision_offered")
    .notNull()
    .default("R 0"),
  incomeEscalation: text("income_escalation").notNull().default("0%"),
  estateDutyPoliciesOnLife: text("estate_duty_policies_on_life")
    .notNull()
    .default("0%"),
  ...
  contributionEscalation: text("contribution_escalation")
    .notNull()
    .default("0%"),
...
export const updateRetirementFundSchema = createInsertSchema(retirementFunds)
  .omit({
    id: true,
  })
  .partial();
...
export const insertLumpSumBequestSchema = createInsertSchema(
  lumpSumBequests
).omit({
  id: true,
});

export const updateLumpSumBequestSchema = createInsertSchema(lumpSumBequests)
  .omit({
    id: true,
  })
  .partial();
...
export const updateClientDetailsSchema = createInsertSchema(clientDetails)
  .omit({
    id: true,
  })
  .partial();
...
export const assurance = pgTable("assurance", {
  ...
  beneficiaryPercentages: text("beneficiary_percentages")
    .array()
    .notNull()
    .default(["100%"]),
  ...
  amountYearsValues: text("amount_years_values")
    .array()
    .notNull()
    .default(["0 years"]), // Per-beneficiary years values
  amountIncreaseValues: text("amount_increase_values")
    .array()
    .notNull()
    .default(["0%"]), // Per-beneficiary percentage values
  ...
  excludedFromEstateDuty: boolean("excluded_from_estate_duty")
    .notNull()
    .default(false),
  excludedFromProvisions: boolean("excluded_from_provisions")
    .notNull()
    .default(false),
...
export const updateAssuranceSchema = createInsertSchema(assurance)
  .omit({
    id: true,
  })
  .partial();
...
export const definedBenefitFunds = pgTable("defined_benefit_funds", {
  ...
  additionalTaxFreeAmount: text("additional_tax_free_amount")
    .notNull()
    .default("R 0"),

  // Pension Income at Death Section
  pensionIncomeAmount: text("pension_income_amount").notNull().default("R 0"),
  pensionIncomeCheckbox: boolean("pension_income_checkbox")
    .notNull()
    .default(true), // Toggle: true = Years mode, false = % mode
  pensionIncomeYears: text("pension_income_years").notNull().default("0 years"),
  pensionIncomeIncrease: text("pension_income_increase")
    .notNull()
    .default("0%"),
...
export const insertDefinedBenefitFundSchema = createInsertSchema(
  definedBenefitFunds
).omit({
  id: true,
});

export const updateDefinedBenefitFundSchema = createInsertSchema(
  definedBenefitFunds
)
  .omit({
    id: true,
...
export type InsertDefinedBenefitFund = z.infer<
  typeof insertDefinedBenefitFundSchema
>;
export type UpdateDefinedBenefitFund = z.infer<
  typeof updateDefinedBenefitFundSchema
>;
...
export const voluntaryInvestments = pgTable("voluntary_investments", {
  ...
  // Exclusions Section
  excludedFromJointEstate: boolean("excluded_from_joint_estate")
    .notNull()
    .default(false),
  excludedFromEstateDuty: boolean("excluded_from_estate_duty")
    .notNull()
  ...
  excludedFromExecutorsFees: boolean("excluded_from_executors_fees")
    .notNull()
    .default(false),
...
export const insertVoluntaryInvestmentSchema = createInsertSchema(
  voluntaryInvestments
).omit({
  id: true,
});

export const updateVoluntaryInvestmentSchema = createInsertSchema(
  voluntaryInvestments
)
  .omit({
    id: true,
...
export type InsertVoluntaryInvestment = z.infer<
  typeof insertVoluntaryInvestmentSchema
>;
export type UpdateVoluntaryInvestment = z.infer<
  typeof updateVoluntaryInvestmentSchema
>;
...
export const updateIncomeNeedsSchema = createInsertSchema(incomeNeeds)
  .omit({
    id: true,
  })
  .partial();
...
export const insertIncomeProvisionsSchema = createInsertSchema(
  incomeProvisions
).omit({
  id: true,
});

export const updateIncomeProvisionsSchema = createInsertSchema(incomeProvisions)
  .omit({
    id: true,
  })
  .partial();
...
export type InsertIncomeProvisions = z.infer<
  typeof insertIncomeProvisionsSchema
>;
export type UpdateIncomeProvisions = z.infer<
  typeof updateIncomeProvisionsSchema
>;
...
export const updateResidueSchema = createInsertSchema(residue)
  .omit({
    id: true,
  })
  .partial();
...
export const additionalEstateDutyItems = pgTable(
  "additional_estate_duty_items",
  {
    id: serial("id").primaryKey(),
    ...
    excludeFromJointEstate: boolean("exclude_from_joint_estate")
      .notNull()
      .default(false),
  }
);

export const insertAdditionalEstateDutyItemsSchema = createInsertSchema(
  additionalEstateDutyItems
).omit({
  id: true,
});

export const updateAdditionalEstateDutyItemsSchema = createInsertSchema(
  additionalEstateDutyItems
)
  .omit({
    id: true,
...
export type AdditionalEstateDutyItems =
  typeof additionalEstateDutyItems.$inferSelect;
export type InsertAdditionalEstateDutyItems = z.infer<
  typeof insertAdditionalEstateDutyItemsSchema
>;
export type UpdateAdditionalEstateDutyItems = z.infer<
  typeof updateAdditionalEstateDutyItemsSchema
>;
...
export const updateLiabilitiesSchema = createInsertSchema(liabilities)
  .omit({
    id: true,
  })
  .partial();
...
export const estatePositionParameters = pgTable("estate_position_parameters", {
  ...
  accrualClaimFromSpouse: text("accrual_claim_from_spouse")
    .notNull()
    .default("R 0"),
  dependantsSurplusUtilised: text("dependants_surplus_utilised")
    .notNull()
    .default("R 0"),
  ownEstateCapitalProvided: text("own_estate_capital_provided")
    .notNull()
    .default("R 0"), // Calculated
  ...
  settleClientLiabilities: text("settle_client_liabilities")
    .notNull()
    .default("R 0"),
  capitalGainsTax: text("capital_gains_tax").notNull().default("R 0"),
  mastersFee: text("masters_fee").notNull().default("R 0"),
  deathBedFuneralExpenses: text("death_bed_funeral_expenses")
    .notNull()
    .default("R 0"),
  conveyancingValuationFees: text("conveyancing_valuation_fees")
    .notNull()
    .default("R 0"),
  accrualClaimToSpouse: text("accrual_claim_to_spouse")
    .notNull()
    .default("R 0"),
  ownEstateCapitalRequired: text("own_estate_capital_required")
    .notNull()
    .default("R 0"), // Calculated

  // Results Section (all calculated)
  surplus: text("surplus").notNull().default("R 0"), // Calculated
  estateSurplusUtilisedForDependants: text(
    "estate_surplus_utilised_for_dependants"
  )
    .notNull()
    .default("R 0"), // Calculated
  estatePositionAfterAllocation: text("estate_position_after_allocation")
    .notNull()
    .default("R 0"), // Calculated
...
export const insertEstatePositionParametersSchema = createInsertSchema(
  estatePositionParameters
).omit({
  id: true,
});

export const updateEstatePositionParametersSchema = createInsertSchema(
  estatePositionParameters
)
  .omit({
    id: true,
...
export type EstatePositionParameters =
  typeof estatePositionParameters.$inferSelect;
export type InsertEstatePositionParameters = z.infer<
  typeof insertEstatePositionParametersSchema
>;
export type UpdateEstatePositionParameters = z.infer<
  typeof updateEstatePositionParametersSchema
>;
...
export const financialPlans = pgTable("financial_plans", {
  ...
  dateApplicable: text("date_applicable")
    .notNull()
...
export const insertFinancialPlanSchema = createInsertSchema(
  financialPlans
).omit({
  id: true,
});

export const updateFinancialPlanSchema = createInsertSchema(financialPlans)
  .omit({
    id: true,
  })
  .partial();
...
export const updateNeedSchema = createInsertSchema(needs)
  .omit({
    id: true,
  })
  .partial();
...
export const updatePlanNeedSchema = createInsertSchema(planNeeds)
  .omit({
    id: true,
  })
  .partial();
...
export const retirementParameters = pgTable("retirement_parameters", {
  ...
  retirementPlanningAge: integer("retirement_planning_age")
    .notNull()
    .default(90),
  autoCalculateTax: boolean("auto_calculate_tax").notNull().default(true),
  currentAnnualIncome: text("current_annual_income").notNull().default("R 0"),
  // Projection assumptions, read by the Project drawdown calculator as its
  // defaults. cpi = inflation; yieldPremium = real return above CPI.
  cpi: text("cpi").notNull().default("4.5%"),
  yieldPremium: text("yield_premium").notNull().default("3%"),
  lastUpdated: text("last_updated").notNull().default(new Date().toISOString()),
});

export const insertRetirementParametersSchema = createInsertSchema(
  retirementParameters
).omit({
  id: true,
});

export const updateRetirementParametersSchema = createInsertSchema(
  retirementParameters
)
  .omit({
    id: true,
...
export type InsertRetirementParameters = z.infer<
  typeof insertRetirementParametersSchema
>;
export type UpdateRetirementParameters = z.infer<
  typeof updateRetirementParametersSchema
>;
...
export const futureInflows = pgTable("future_inflows", {
  ...
  startYearsAfterRetirement: integer("start_years_after_retirement")
    .notNull()
    .default(0),
...
export const updateFutureInflowSchema = createInsertSchema(futureInflows)
  .omit({
    id: true,
  })
  .partial();
...
export const insertRetirementLumpSumNeedSchema = createInsertSchema(
  retirementLumpSumNeeds
).omit({
  id: true,
});

export const updateRetirementLumpSumNeedSchema = createInsertSchema(
  retirementLumpSumNeeds
)
  .omit({
    id: true,
...
export type InsertRetirementLumpSumNeed = z.infer<
  typeof insertRetirementLumpSumNeedSchema
>;
export type UpdateRetirementLumpSumNeed = z.infer<
  typeof updateRetirementLumpSumNeedSchema
>;
